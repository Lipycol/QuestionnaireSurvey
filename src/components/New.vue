    ...
    <el-container>
      <!-- 侧边栏区域 -->
        ...
        <el-menu class="left-aside"> 
          ...
          <el-menu-item index="2" class="item" @click="reload">
            <i class="el-icon-circle-plus-outline" style="font-size: 18px; color: #1E90FF"></i>
            <span slot="title"  style="font-size: 18px; color: #1E90FF">新建问卷</span>
          </el-menu-item>
...
<div class="edit-container">
    ...
    <div class="shadow" v-if="showAddQsDialog">
      <div class="add-qs-dialog">
        ...
        <label v-if="showAddOptionInput">请输入选项<el-input placeholder="请输入选项" prefix-icon="el-icon-edit" style="width:350px" v-model="qsInputOptions"></el-input></label>
        <div class="btn-box">

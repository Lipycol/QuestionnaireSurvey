<template>
  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item style="width:100%;" v-if="alter != 1">
      <el-button type="primary" style="width:100%;" @click.native.prevent="alterName">修改用户名</el-button>
    </el-form-item>
    <el-form-item style="width:100%;" v-if="alter != 2">
      <el-button type="primary" style="width:100%;" @click.native.prevent="alterPass">修改密码</el-button>
    </el-form-item>
    <div v-if="alter == 1">
